 ...
 */
 ...
 compositions.add(new Composition(pastellishWalker1, pastellishWalker2, pastellishWalker3, pastellishWalker4, pastellishWalker5, flashMeWhite));
  ...
  compositions.add(new Composition(pinkSlowBreathing, pumpingPurple, darkBlueRunner));
  ...
  compositions.add(new Composition(randomIkeaFlash1, randomIkeaFlash2, randomIkeaFlash3, randomIkeaFlash4, randomIkeaFlash1.clone(), randomIkeaFlash2.clone(), randomIkeaFlash3.clone(), randomIkeaFlash4.clone()));
